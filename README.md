...
![FinEase](https://img.shields.io/badge/Version-1.1b-blue.svg)
...
### Development Setup
```bash
git clone https://github.com/dapoalla/apt-finance-manager.git
cd apt-finance-manager
...
- **Developer**: Dapo Alla
- **Email**: [dapo.alla@gmail.com](mailto:dapo.alla@gmail.com)
- **GitHub**: [github.com/dapoalla/apt-finance-manager](https://github.com/dapoalla/apt-finance-manager)
